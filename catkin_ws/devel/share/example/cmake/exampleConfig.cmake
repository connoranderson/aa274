...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /home/aa274/catkin_ws/src/example)
  set(example_DEVEL_PREFIX /home/aa274/catkin_ws/devel)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /home/aa274/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'aa274 <aa274@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aa274/catkin_ws/src/example/${idir}'.  Ask the maintainer 'aa274 <aa274@todo.todo>' to fix it.")
    endif()
