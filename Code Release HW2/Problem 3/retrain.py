# Taken from https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/image_retraining/retrain.py
# Slightly modified to expose logits for saliency computation (line 730); some flag defaults changed as well
